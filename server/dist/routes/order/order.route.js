...
var authenticateCreateOrder_1 = __importDefault(require("../../middlewares/authenticateCreateOrder"));
var errorHandler_1 = require("../../middlewares/errorHandler");
var router = express_1.Router();
router.get("/", authenticate_1["default"], errorHandler_1.handleErrorAsync(order_controller_1["default"].getOrders));
router.post("/create_order", authenticateCreateOrder_1["default"], errorHandler_1.handleErrorAsync(order_controller_1["default"].createOrder));
